...
function dragElement(elmnt) {
	...
	var obj_SC = document.getElementById("War");
	var obj_NC = document.getElementById("AntiWar");
...
function getCard(){
	$.get(origin+'/api/card', {SortingType:'Benefit', Previous:'0'}, getCardCallback);
}
...
function getPreviousCard(){
	$.get(origin+'/api/card', {SortingType:'Benefit', Previous:'1'}, getPreviousCallback);
}
...
function undoSort(){
	$.post(origin+"/api/card/undo",{SortingType:'Benefit'}, undoCallback);
}
